...
install() {
  ...
  local AURORAE_THEME=${AURPRAE_DIR}/${name}-light
  ...
  local KVANTUM_THEME=${KVANTUM_DIR}/${name}-light
  ...
  cp -ur ${SRC_DIR}/aurorae/themes/${name}-light                                     ${AURORAE_DIR}
  cp -ur ${SRC_DIR}/color-schemes/${name}${color}.colors                             ${SCHEMES_DIR}
  cp -ur ${SRC_DIR}/Kvantum/${name}-light                                            ${KVANTUM_DIR}
  cp -ur ${SRC_DIR}/plasma/desktoptheme/${name}${color}                              ${PLASMA_DIR}
  cp -ur ${SRC_DIR}/color-schemes/${name}${color}.colors                             ${PLASMA_THEME}/colors
